...
│   └── emi                      => Micro-FrontEnd for [emi FrontEnd](https://gitlab.com/git_rep_directoryo_directory_path/emi)
├── api                                 => Micro-APIs  
│   └── emi-gateway                           => Micro-API for [emi-gateway API](https://https://github.com/nebulae-interview/emi-gateway)  
...
These are the exposed GraphQL functions throught the [emi-gateway API](https://https://github.com/nebulae-interview/emi-gateway).  
...
Time-based jobs that are configured and triggered by the [CronJob MicroService](https://https://github.com/nebulae-interview/ms-cronjob)
...
### 1. clone this repo  
   ```git clone https://https://github.com/nebulae-interview/ms-micro-service-template.git```  
...
### 5. Compose FrontEnd
```
nebulae compose-ui development --shell-type=FUSE2_ANGULAR --shell-repo=https://https://github.com/nebulae-interview/emi --frontend-id=emi --output-dir=/FULL_PATH_TO_REPO/ms-micro-service-template/playground/emi  --setup-file=/FULL_PATH_TO_REPO/ms-micro-service-template/etc/mfe-setup.json
```

### 6. Compose the API emi-gateway
```
nebulae compose-api development --api-type=NEBULAE_GATEWAY --api-repo=https://https://github.com/nebulae-interview/emi-gateway --api-id=emi-gateway --output-dir=FULL_PATH_TO_REPO/ms-micro-service-template/playground/emi-gateway  --setup-file=FULL_PATH_TO_REPO/ms-micro-service-template/etc/mapi-setup.json
```
